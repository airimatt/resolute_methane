...
def plot_agwp_lines(co2_plot, ch4_plot, n2o_plot, agwp_net_plot, agtp_net_plot, metric):
    """
    Purpose: Plots the AGWP graph
    ...
    if metric != "none":
        for t in range(1, time):
            co2e_plot[t:] += co2e_emissions[t - 1] * agwp_co2[:time - t]
    ...
    lines.append((x_range, agwp_net_plot, f"Net"))
